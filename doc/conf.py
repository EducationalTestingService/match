...
latex_documents = [
  ('index', 'match.tex', u'match Documentation',
   u'Diane M. Napolitano', 'manual'),
]
...
man_pages = [
    ('index', 'match', u'match Documentation',
     [u'Diane M. Napolitano'], 1)
]
...
texinfo_documents = [
  ('index', 'match', u'match Documentation',
   u'Diane M. Napolitano', 'match', 'One line description of project.',
   'Miscellaneous'),
]
